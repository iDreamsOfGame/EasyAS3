...
package org.easyas3.vinci.display
{
	 ...
	 * @author Jerry
	 */
	public class PixelInteractiveMovieClipBitmapMovie extends MovieClipBitmapMovie
	{
		/**
		 * 像素级交互代理
		 * @private
		 ...
		 */
		public function PixelInteractiveMovieClipBitmapMovie(frames:Vector.<BitmapFrameInfo> = null)
		{
			super(frames);
