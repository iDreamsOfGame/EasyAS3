package org.easyas3.ui
{
	 ...
	 * @version 0.4.0
	 */
	public final class EasyContextMenu extends EventDispatcherBase
	{
		 ...
		 */
		public function EasyContextMenu(target:InteractiveObject,
										removeBuiltInItems:Boolean = true) : void
		{
			this.target = target;
		 ...
		 */
		public function addCallbackMenuItem(caption:String, callback:Function,
		 ...
		 * @param	visible:Boolean (default = true) —— 菜单项是否可见
		 */
		public function addLinkMenuItem(caption:String, url:String, window:String = null,
										separatorBefore:Boolean = false, enabled:Boolean = true,
										visible:Boolean = true) : void
		{
			var menuItem:EasyContextMenuItem = addItem(caption, separatorBefore, enabled, visible);
		 ...
		 * @param	visible:Boolean (default = true) —— 菜单项是否可见
		 */
		public function addMenuItem(caption:String, separatorBefore:Boolean = false,
									enabled:Boolean = true, visible:Boolean = true) : void
		{
		 ...
		 */
		private function addItem(caption:String, separatorBefore:Boolean = false,
								 enabled:Boolean = true, visible:Boolean = true) : EasyContextMenuItem
		{
			var menuItem:EasyContextMenuItem = findMenuItemByCaption(caption);
