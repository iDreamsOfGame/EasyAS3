	...
	public class PropertyInjectionPoint extends InjectionPoint
	{
		...
		*******************************************************************************************/
		...
		override public function applyInjection(target : Object, injector : Injector) : Object
		{
			...
			{
				throw(
					new InjectorError('Injector is missing a rule to handle injection into target ' + target + '. Target dependency: ' + propertyType)
					);
			}
		...
		*******************************************************************************************/
		override protected function initializeInjection(node : XML, injector : Injector) : void
		{
			...
			m_injectionConfig = injector.getMapping(Class(injector.getApplicationDomain().getDefinition(propertyType)), node.arg.attribute('value').toString());
		}
	}
}