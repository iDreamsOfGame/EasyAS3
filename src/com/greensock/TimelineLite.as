...
package com.greensock
{
	 ...
	 * but in TimelineMax, they could be different. For example, if a TimelineMax instance
		...
		override public function get rawTime() : Number
		{
			...
			{ //note: don't use this.totalDuration because if other tweens get unpaused before this one, the totalDuration could change.  
		...
		override public function get totalDuration() : Number
		{
			if(this.cacheIsDirty)
			{
				...
				while(tween)
				{
					...
					{ //children aren't allowed to have negative startTimes, so adjust here if one is found.
